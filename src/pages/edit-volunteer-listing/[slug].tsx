...
const EditVolunteerListing = () => {
  ...
  useEffect(()=>{
    axios
      .get(
        `${baseUrl}/volunteer-listings/${slug}/show?org=${orgslug}`,
        {
          headers: {
            Authorization: "Bearer " + accessToken(),
            // 'Content-Type': 'application/x-www-form-urlencoded'
  ...
  const handleSubmit = (e:any) =>{
    ...
    axios.post(`${baseUrl}/volunteer-listings/${slug}/update?org=${orgslug}`, form, {
      headers: {
        Authorization: 'Bearer ' + accessToken(),
      }
    })
  ...
  return (
    ...
    <div className="d-flex justify-content-between col-md-8">
        <p className="listing-txt mt-5">Edit Volunteer Listing</p>
      </div>
           <form>
